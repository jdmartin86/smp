...
#include <smp/components/extenders/lq_qp.hpp>   
...
#define NUM_DIMENSIONS 4     // Change the number of dimensions from here
...
typedef state_lq_qp<NUM_DIMENSIONS> state_t;
typedef input_lq_qp input_t;
...
typedef extender_lq_qp<typeparams,NUM_DIMENSIONS> extender_t;
